...
/**
 * College Settings page — theme preferences and notification settings.
 */
export default function CollegeSettings() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        title="Settings"
        description="Manage your coordinator account preferences."
      />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Receive alerts for classroom approvals, trainer assignments, and schedules.
                </p>
              </div>
            </div>
            <button
